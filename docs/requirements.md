...
| REQ-15 | 3 | The system should allow an orderer to move to order decision from shopping cart page. | F |
| REQ-16 | 3 | The system shall make the order page accessible only from the shopping cart page. | NF |
